...
function(setup_agent _srcs _inputs)
  ...
  target_link_libraries(${_exe_name} PRIVATE amrex)
  if (ENABLE_CONTAM)
    find_package(ContamClient)
    if (ContamClient_FOUND)
      message(STATUS "Contam found: ${ContamClient_DIR}")
    else()
      message(FATAL_ERROR "ContamClient not found!")
    endif()
    target_compile_definitions(${_exe_name} PRIVATE USE_CONTAM)
    target_link_libraries(${_exe_name} PRIVATE ContamClient::contam_client)
  endif()
